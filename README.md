...
<div align="center">
  ...
  <h2 align="center">BikeBazaar: Your Premier Cycling Destination</h2>

 BikeBazaar is a fully responsive website, <br />Responsive for all devices, build using HTML, CSS, and JavaScript.

  <a href="https://bike-bazaar.netlify.app/"><strong>➥ Live Demo</strong></a>
...
To run **BikeBazaar** locally, run this command on your git bash:

Linux and macOS:

```bash
sudo git clone https://github.com/Asifmohamed007/BikeBazaar.git
```

Windows:

```bash
git clone https://github.com/Asifmohamed007/BikeBazaar.git
```
